/*
 * Project Name: writedata.cyfx
 * Time : 02/28/2012 14:36:26
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x2E707001,0x00000CC0,0x80000800},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739C02,0x10000400,0x80000800},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739C03,0x00000000,0x81000800},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739C04,0x00000000,0x80000800},{0x00000000,0x00000000,0x00000000}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x54000015,  /*  PIB_GPIF_CTRL_BUS_DIRECTION */
    ...
    0x00000002,  /*  PIB_GPIF_CTRL_BUS_SELECT */
    0x00000000,  /*  PIB_GPIF_CTRL_BUS_SELECT */
    0x00000000,  /*  PIB_GPIF_CTRL_BUS_SELECT */
    0x00000000,  /*  PIB_GPIF_CTRL_BUS_SELECT */
    0x00000000,  /*  PIB_GPIF_CTRL_BUS_SELECT */
