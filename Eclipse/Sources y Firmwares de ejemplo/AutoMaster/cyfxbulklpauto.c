        ...
        uint32_t input)
{
    ...
    for (;;)
    {
        ...
        CyU3PGpioSimpleSetValue (23, 0);
		CyU3PGpioSimpleSetValue (25, 1);
		CyU3PGpioSimpleSetValue (26, 0);
		CyU3PGpioSimpleSetValue (27, 1);
		CyU3PGpioSimpleSetValue (50, 0);
		CyU3PGpioSimpleSetValue (51, 1);
		CyU3PGpioSimpleSetValue (52, 0);
		CyU3PGpioSimpleSetValue (57, 1);
        /*
