    ...
    )
{
	...
	size_t szBytestoReturn=0,szRequiredSize=0,szOutBufferLength,szDeviceAddressBufSize = 1;//sizeof(UCHAR);
	WDFDEVICE           device;
    PDEVICE_CONTEXT     pDevContext;
	PUCHAR  puDeviceAddress=NULL,puDeviceAddresstmp=NULL;
	...
	WdfMemoryCopyToBuffer(memory,0,puDeviceAddress,szDeviceAddressBufSize);	
